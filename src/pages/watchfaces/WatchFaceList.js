...
class WatchFaceList extends Component {
    ...
    renderRows(){
        ...
        watchfaces.forEach((watchfaceObj, index) => {
            rows.push(<WatchFace key={watchfaceObj.id} author={watchfaceObj.author} screenshot={watchfaceObj.screenshot} firmware={watchfaceObj.firmware} github={watchfaceObj.source} name={watchfaceObj.name} />);
            if((index+1) % 3 == 0){
